...
urlpatterns = [
    ...
    url('friends/',include('friends.url')),
    url('like_movie/',include('like_movie.url')),
    url('login/',include('login.url')),
    url('movie/',include('movie.url')),
    url('request/',include('request.url')),
    url('source/',include('source.url')),
